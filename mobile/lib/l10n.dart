...
class AppLocalizations {
  ...
  String get manuallyLocked => _t('manuallyLocked');
  String get remainingToday => _t('remainingToday');
  ...
  static const _en = <String, String>{
    ...
    'lockNowConfirmBody': 'This will lock access until you explicitly unlock it. Today’s remaining time will not change.',
    'unlock': 'Unlock',
    'unlockConfirmTitle': 'Unlock screen time?',
    'unlockConfirmBody': 'Clear the manual lock? Schedule and daily limits still apply.',
  ...
  static const _pl = <String, String>{
    ...
    'lockNowConfirmBody': 'Dostęp zostanie zablokowany do czasu ręcznego odblokowania. Dzisiejszy pozostały czas się nie zmieni.',
    'unlock': 'Odblokuj',
    'unlockConfirmTitle': 'Odblokować czas ekranu?',
    'unlockConfirmBody': 'Usunąć ręczną blokadę? Harmonogram i limity dzienne nadal obowiązują.',
    ...
    'manuallyLocked': 'Zablokowany ręcznie',
    'remainingToday': 'pozostało na dziś',
  ...
  static const _es = <String, String>{
    ...
    'lockNowConfirmBody': 'Esto bloqueará el acceso hasta que lo desbloquees expresamente. El tiempo restante de hoy no cambiará.',
    'unlock': 'Desbloquear',
    'unlockConfirmTitle': '¿Desbloquear el tiempo de pantalla?',
    'unlockConfirmBody': '¿Quitar el bloqueo manual? El horario y los límites diarios siguen aplicándose.',
    ...
    'manuallyLocked': 'Bloqueado manualmente',
  ...
  static const _fr = <String, String>{
    ...
    'lockNowConfirmBody': "L’accès sera verrouillé jusqu’à son déverrouillage explicite. Le temps restant aujourd’hui ne changera pas.",
    'unlock': 'Débloquer',
    'unlockConfirmTitle': "Débloquer le temps d'écran ?",
    'unlockConfirmBody': "Effacer le verrouillage manuel ? Les horaires et limites quotidiennes restent applicables.",
    ...
    'manuallyLocked': 'Verrouillé manuellement',
  ...
  static const _de = <String, String>{
    ...
    'lockNowConfirmBody': 'Der Zugriff bleibt gesperrt, bis Sie ihn ausdrücklich entsperren. Die heutige Restzeit ändert sich nicht.',
    'unlock': 'Entsperren',
    'unlockConfirmTitle': 'Bildschirmzeit entsperren?',
    'unlockConfirmBody': 'Manuelle Sperre aufheben? Zeitplan und Tageslimits gelten weiterhin.',
    ...
    'manuallyLocked': 'Manuell gesperrt',
  ...
  static const _pt = <String, String>{
    ...
    'lockNowConfirmBody': 'Isso bloqueará o acesso até que você o desbloqueie explicitamente. O tempo restante de hoje não mudará.',
    'unlock': 'Desbloquear',
    'unlockConfirmTitle': 'Desbloquear o tempo de tela?',
    'unlockConfirmBody': 'Remover o bloqueio manual? A agenda e os limites diários continuam valendo.',
